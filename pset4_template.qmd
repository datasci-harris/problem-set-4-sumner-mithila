...
#Using the cleaned file from the previous step and converting zip codes to string
filtered_data['ZIP_CD'] = filtered_data['ZIP_CD'].astype(str).str.split('.').str[0]
filtered_data.rename(columns={'ZIP_CD': 'ZCTA5'}, inplace=True)



#Merging
merged_sets = subset_tx.merge(filtered_data, on='ZCTA5', how='outer')
...
#Converting both to string and merging
subset_tx['ZCTA5'] = subset_tx['ZCTA5'].astype(str)
grouped_tx_hosp.loc[:, 'ZCTA5'] = grouped_tx_hosp['ZCTA5'].astype(str)
merged_data = subset_tx.merge(grouped_tx_hosp, on='ZCTA5', how='outer')
```
